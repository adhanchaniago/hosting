      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub">
                      <a onclick="init();listTourism();" style="cursor:pointer;background:none"><i class="fa fa-list"></i>&nbsp List Tourism</a>
                  </li>

                  <li class="sub">
                      <a onclick="" style="cursor:pointer;background:none"><i class="fa fa-thumb-tack"></i>&nbsp Tourism Around You</a>
...
<!--                   <li class="sub">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <div class="form-group" style="color: white;" >
                          ...
                          <a><i class="fa fa-gear"></i> Tourism Name</a>
                          <li style="margin-top:10px"><input id="input_name" type="text" class="form-control"></li>

                          <a><i class="fa fa-gear"></i> Mesjid Name</a>
                          <li style="margin-top:10px"><input id="input_name" type="text" class="form-control"></li>

                          <a><i class="fa fa-gear"></i> Souvenir Name</a>
                          <li style="margin-top:10px"><input id="input_name" type="text" class="form-control"></li>

                          <a><i class="fa fa-gear"></i> Hotel Name</a>
                          <li style="margin-top:10px"><input id="input_name" type="text" class="form-control"></li>                                                     

                          <label for="inputradius" style="font-size: 10pt; margin-top: 20px;";>Radius : </label>
                          <label  id="nilai"  style="font-size: 10pt";>0</label> m
                          
                          <input  type="range" onchange="init();tourism_sekitar_user();cekkk();cari_tourism(1)" id="inputradius" 
                                  name="inputradius" data-highlight="true" min="0" max="20" value="0">
                          <script>
                            function cekkk()
                            {
...
<!--                   <li class="sub">
                      <a onclick="gallery()" style="cursor:pointer;background:none">
                          <i class="fa fa-image"></i>
                          <span>Gallery Recommendation</span>
                      </a>
                  </li> -->
