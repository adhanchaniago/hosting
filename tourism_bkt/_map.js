        var map;
        var server = "http://52.163.52.150/hosting/tourism_bkt/";
        ...
        {
          $('#tombol').empty();
          $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-default " data-toggle="tooltip" title="Sembunyikan Legenda" style="margin-right: 5px;color:orange;"><i class="fa fa-eye-slash style="margin-right: 5px; color:orange;"></i></a> ');
        ...
        function hideLegenda() {
          ...
          $('#tombol').empty();
          console.log("Sukses");
          $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-default " data-toggle="tooltip" title="Legenda" style="margin-right: 5px; color:orange;"><i class="fa fa-eye" style="color:orange;"> </i></a>');
        }
        ...
        function gallery2(){
          ...
          { 
              for (var i in rows){ 
                ...
                var latitude=row.lat;
                var longitude = row.lng;
                $('#kanan_table').append("<tr><td>"+name+"</td></tr>");  
      ...
      *********************************************************************************************************************************************************** */
        ...
        function aktifkanRadius(){
          ...
          if (!document.getElementById("check_i").checked && !document.getElementById("check_k").checked && !document.getElementById("check_m").checked && !document.getElementById("check_oo").checked && !document.getElementById("check_tw").checked && !document.getElementById("check_h").checked && !document.getElementById("check_r").checked) {          
            document.getElementById('modal_title').innerHTML="Info";
            document.getElementById('modal_body').innerHTML="Choose One of the Object";
            $('#myModal').modal('show'); 
          } else {
          $('#view_table_sekitar').show();          
          }
      ...
      function route_sekitar(lat1,lng1,lat,lng) {
          ...
          if (lat1 == 0 || lat == 0 || lng1 == 0 || lng == 0) {          
            document.getElementById('modal_title').innerHTML="Info";
            document.getElementById('modal_body').innerHTML="Mark Your Location first.<br>Please Reload Data to Running this Function";
            $('#myModal').modal('show'); 
            return;
          }
