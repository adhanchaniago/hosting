          ...
          <section class="wrapper">
              ...
              <div class="row">
                <div  class="col-lg-8 main-chart">    
                        ...
                        <div class="white-panel pns">
                          ...
                          <header class="panel-heading" style="float:left">
                            <label style="color: black; margin-right:20px">Google Map with Location List
                              ...
                              <a class="btn btn-default" role="button" data-toggle="collapse" onclick="posisisekarang()" title="Current Position" style="margin-right:5px"><i class="fa fa-location-arrow" style="color:orange;"></i></a>
                              <a class="btn btn-default" role="button" data-toggle="collapse" onclick="lokasimanual()" title=" Manual Position" style="margin-right:5px"><i class="fa fa-map-marker" style="color:orange;"></i></a>
                              <label id="tombol">
                              <a class="btn btn-default" role="button" id="showlegenda" data-toggle="collapse" onclick="legenda()" title="Legend" style="margin-right:5px"><i class="fa fa-eye" style="color:orange;"></i></a>
                              </label>
                          </header>
                  ...
                  <div class="row" id="galleryrecommend">                   
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns">

                          <header class="panel-heading" style=" padding-top: 12px;padding-left: 50px; width: 96%"  >
                            <label class="btn btn-compose" style="color: white; margin-right:20px">Gallery Recommendation
                            </label>
                          </header>
                           ...
                           <div id="gallery1" style="height: 510px">
                            <div>
                              <a href="#" onclick="galeri1('tw001')"><img src="../_foto/tw0012.jpg" style="height: 200px;"></a>
                              <a href="#" onclick="galeri1('tw004')"><img src="../_foto/tw0041.jpg" style="height: 200px; padding-left: 80px"></a>

                              <div><a style="padding-right: 250px">Jam Gadang</a> <a>Lobang Jepang</a></div>

                              <a href="#" onclick="galeri1('tw011')"><img src="../_foto/tw0113.jpg" style="height: 230px; padding-top: 20px; padding-top: 20px"></a>
                              <a href="#" onclick="galeri1('tw005')"><img src="../_foto/tw0051.jpg" style="height: 230px; padding-left: 50px; padding-top: 20px"></a>

                              <div><a style="padding-right: 270px">Ngarai Sianok</a> <a>Great Wall</a></div>
                            </div>
                          </div>
                        </div>
                      </div>                
              ...
              <div class="row"  id="galleryrecommendxxx">
                      ...
                      <div class="col-md-11 col-sm-12 mb">
                        <div class="white-panel pns" style="height: 310px">
                          <header class="panel-heading" style=" width: 100%"  >
                            <label class="btn btn-compose" id="judul_table" style="margin-bottom: 0px">Tourism Recommendation
                            </label>
                          </header>

                           <div class="imam-slider" id="gallery1">
                            <div class="isi-slider">
                              <a href="" onclick="galleryreco('tw001')"><img src="../_foto/tw0012.jpg"></a>
                              <a href="" onclick="galleryreco('tw011')"><img src="../_foto/tw0113.jpg"></a>
                              <a href="" onclick="galleryreco('tw004')"><img src="../_foto/tw0041.jpg"></a>
                              <a href="" onclick="galleryreco('tw005')"><img src="../_foto/tw0051.jpg"></a>
                            </div>
                          </div>
                        </div>
                      </div>                
